...
def upgrade() -> None:
    ...
    sa.Column('restrictions', sa.ARRAY(sa.String(), dimensions=1), nullable=False),
    ...
    sa.Column('mx', sa.String(), nullable=False),
    sa.Column('restrictions', sa.ARRAY(sa.String(), dimensions=1), nullable=False),
    sa.Column('id', sa.BigInteger(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('description', sa.StringText(), server_default='', nullable=False),
    ...
    sa.Column('body', sa.StringText(), nullable=False),
    ...
    sa.Column('to_user_id', sa.BigInteger(), nullable=False),
    sa.Column('subject', sa.StringText(), nullable=False),
    sa.Column('body', sa.StringText(), nullable=False),
    sa.Column('ref', sa.StringText(), nullable=True),
    ...
    sa.Column('redirect_uris', sa.ARRAY(sa.String(length=1000), dimensions=1), nullable=False),
    sa.Column('avatar_id', sa.String(length=64), nullable=True),
    sa.Column('id', sa.BigInteger(), nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('statement_timestamp()'), nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('statement_timestamp()'), nullable=False),
    ...
    sa.Column('tags', sa.ARRAY(sa.String(length=40), dimensions=1), server_default='{}', nullable=False),
    sa.Column('id', sa.BigInteger(), sa.Identity(always=False, minvalue=1), nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('statement_timestamp()'), nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('statement_timestamp()'), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
